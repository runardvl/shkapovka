...
export default {
  ...
  data() {
    return {
      pageMeta: {
        title: 'Правила и полезная информация',
        description: 'Правила и полезная информация на базе отдыха Шкаповка',
      },
    ...
    meta: [
      {
        ...
        name: 'description',
        content:
          'Правила и полезная информация базы отдыха Шкаповка в Азнакаево',
      },
    ],
  },
}
